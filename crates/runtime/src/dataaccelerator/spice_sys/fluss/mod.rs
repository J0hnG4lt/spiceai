...
const FLUSS_CHECKPOINTS_TABLE_NAME: &str = "spice_sys_fluss_checkpoints";
...
pub struct FlussCheckpointMetadata {
...
impl FlussSys {
    ...
    pub async fn get(&self) -> Option<FlussCheckpointMetadata> {
    ...
    pub async fn upsert(&self, metadata: &FlussCheckpointMetadata) -> Result<()> {
        match &self.acceleration_connection {
            #[cfg(feature = "duckdb")]
